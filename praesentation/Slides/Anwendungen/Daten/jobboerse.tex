...
\frame{\frametitle{Kultur}
	\begin{figure}
		\includegraphics[width=0.5\textwidth]{Slides/Anwendungen/Daten/pics/town.PNG}\pause
		\includegraphics[width=0.5\textwidth]{Slides/Anwendungen/Daten/pics/town2.PNG}
	\end{figure}
}
...
\frame{\frametitle{Detailgrad}
	...
	\vspace*{0.5cm}
		\begin{itemize}
			...
			\item Welche Anwendung ist am besten?
		\end{itemize}
	}
